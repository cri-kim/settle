...
//	public ResponseEntity<ApiResponseMulti<String>> authList(@RequestBody UserAuthDTO dto) {
//		ApiResponseMulti<String> body = new ApiResponseMulti<String>(ResponseCode.SUCCESS);
//		return new ResponseEntity<ApiResponseMulti<String>>(body,  HttpStatus.OK);
//	}
	
	@RequestMapping(value="/auth/add")
	public ResponseEntity<ApiResponseSingle<String>> authAdd(@RequestBody UserAuthDTO dto){
		ApiResponseSingle<String> body = new ApiResponseSingle<String>(ResponseCode.SUCCESS);
